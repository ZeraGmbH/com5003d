...
cI2CSettings::cI2CSettings(Zera::XMLConfig::cReader *xmlread)
{
    ...
    m_ConfigXMLMap["connectivity:i2c:device:node"] = i2cSettings::SetDevNode;
    m_ConfigXMLMap["connectivity:i2c:adress:master"] = i2cSettings::SetMasterAdr;
    m_ConfigXMLMap["connectivity:i2c:adress:atmel"] = i2cSettings::SetAtmelAdr;
    m_ConfigXMLMap["connectivity:i2c:adress:flash"] = i2cSettings::SetFlashAdr;
