// kommando knoten  für com5003 hardware server
...
#include "com5003d.h" // der eigentliche server


extern QStringList cCom5003Server::MeasChannelList; // liste aller messkanäle
...
cNodeSCPI* System;
    ...
    cNodeSCPI* SystemCommunication;
        ...
        cNodeSCPI* SystemCommunicationI2CMasterAdress;
        cNodeSCPI* SystemCommunicationI2CSlaveAdress;
...
cNode* InitCmdTree() {
    ...
    StatusCName=new cNodeZHServer(&cCom5003Server::MeasChannelList,isQuery,StatusDevice,NULL,nixCmd,GetChannelStatus);
    ...
    CalculateCName=new cNodeZHServer(&cCom5003Server::MeasChannelList,isNode,NULL,CalculateCNameCValue,nixCmd,SetCalculateModel);
