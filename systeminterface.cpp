...
void cSystemInterface::initSCPIConnection(QString leadingNodes, cSCPI *scpiInterface)
{
    ...
    m_DelegateList.append(delegate);
    connect(delegate, SIGNAL(execute(int,QString&,QString&)), this, SLOT(executeCommand(int,QString&,QString&)));
    delegate = new cSCPIDelegate(QString("%1SYSTEM:UPDATE").arg(leadingNodes), "BOOTLOADER", SCPI::isCmd, scpiInterface, SystemSystem::cmdUpdateControlerBootloader);
    m_DelegateList.append(delegate);
    connect(delegate, SIGNAL(execute(int,QString&,QString&)), this, SLOT(executeCommand(int,QString&,QString&)));
    delegate = new cSCPIDelegate(QString("%1SYSTEM:UPDATE").arg(leadingNodes), "PROGRAM", SCPI::isCmd, scpiInterface, SystemSystem::cmdUpdateControlerProgram);
    m_DelegateList.append(delegate);
    connect(delegate, SIGNAL(execute(int,QString&,QString&)), this, SLOT(executeCommand(int,QString&,QString&)));
    delegate = new cSCPIDelegate(QString("%1SYSTEM:UPDATE").arg(leadingNodes), "FLASH", SCPI::isCmdwP, scpiInterface, SystemSystem::cmdUpdateControlerFlash);
    m_DelegateList.append(delegate);
    connect(delegate, SIGNAL(execute(int,QString&,QString&)), this, SLOT(executeCommand(int,QString&,QString&)));
